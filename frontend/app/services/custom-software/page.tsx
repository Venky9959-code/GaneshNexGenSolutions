    ...
    <div className="pt-32 pb-16 px-6 max-w-4xl mx-auto space-y-12">
      <div className="space-y-4 text-center">
        ...
        <p className="text-sm text-slate-600 dark:text-zinc-400 max-w-2xl mx-auto">
          Business applications engineered on ASP.NET Core 9 Web API and PostgreSQL, strictly tailored around your operational workflows.
        </p>
      </div>
      ...
      <div className="pt-8 border-t border-slate-200 dark:border-white/10 space-y-6">
        <div className="text-center space-y-1">
          ...
          <p className="text-xs text-slate-500 dark:text-zinc-400">
            Tell us about your custom software requirements and get in touch with our team.
          </p>
        </div>
        <ContactForm defaultService="Custom Software Development" />
      </div>
    </div>
  );
}
